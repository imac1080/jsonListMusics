 ...
 */
 ...
 function AfegirAjax(){
    ...
    nou_elem = $("<div data-role='page' id='page"+(numItems+1)+"' class='clase_pagina dropdown pull-right'><div data-role='header'><a href='#' data-icon='back'data-rel='back' title='Go back'>Back</a><h1>Page"+(numItems+1)+"</h1></div><div class='ui-content'>"+
